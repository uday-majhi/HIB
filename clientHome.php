...
<body>
	...
	while($row = $result->fetch_assoc()) {
		$images = $row["image"];
?>
                    <img class="profile-user-img img-responsive" width="200px" height="200px"
                        src="<?php echo "../project/uploads/".$images ?>" alt="User profile picture">
                    <?php
		...
		echo "<label for=\"fname\">citizenship_no</label>";
		echo "<input disabled type=\"text\" client_id=\"fname\" name=\"citizenship_no\" placeholder=\"Your citizenship_no..\" value=\"$row[citizenship_no]\">";
