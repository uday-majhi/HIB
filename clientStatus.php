...
<?php
		...
		echo "<label for=\"fname\</label>";
		echo "<input disabled type=\"text\" client_id=\"fname\" name=\"citizenship_no\" placeholder=\"clients citizenship_no..\" value=\"$row[citizenship_no]\">";
